...
// *Exports functions
  // Register user in MongoDB + create token
    exports.register = async (req, res) => {
      ...
      try {
        ...
        await user.save();
        const token = jwt.sign({ id: user._id }, process.env.JWT_SECRET, { expiresIn: TOKEN_DURATION  });
  ...
  // Login user with MongoDB + create token
